...
def bathroom():
    if visited_rooms["bathroom"]:
        ...
        if objetos_recogidos.get("vestido") and objetos_recogidos.get("maquillaje") and objetos_recogidos.get("libro_encantado"):
            pausa()
            print(Fore.LIGHTMAGENTA_EX + "Pista: Un vestido antiguo y maquillaje pálido...")
            pausa()
            print(Fore.LIGHTMAGENTA_EX + "¡Luces como toda una vampira!\n")
            pausa_corta()
            print(Fore.LIGHTMAGENTA_EX + "\n.")
...
def sala_reliquias():
    if visited_rooms["sala_reliquias"]: ### Si ya entraste en la habitación. 
        ...
        if objetos_recogidos.get("daga_plateada") and not objetos_recogidos.get("velas") and not objetos_recogidos.get("mantel"):
            ...
            pausa_larga()
            print(Fore.LIGHTMAGENTA_EX + "Hmm... ¿No eran esos los elementos para el ritual de Carmilla?\n")
            pausa_importante()
            print(Fore.BLUE + "Me pregunto si podrá completar el hechizo sin todos sus ingredientes...")
            pausa()
        ...
        if objetos_recogidos.get("llave"):
            ...
            if objetos_recogidos.get("mantel") and objetos_recogidos.get("velas"):
                ...
                pausa_larga()
                print(Fore.LIGHTMAGENTA_EX + "¿Qué podrías hacer con una daga?")
...
def salon_baile():
    ...
    if objetos_recogidos.get("vestido"):
        ...
        if objetos_recogidos.get("libro_encantado") and objetos_recogidos.get("maquillaje"):
            ...
            pausa_importante()
            print(Fore.BLUE + "Y, con suerte, lograr cruzar la salida escondida entre los vampiros invitados.")
            pausa_importante()
...
def salon_ceremonia():
    ...
    if objetos_recogidos.get("daga_plateada") and objetos_recogidos.get("libro_encantado"):
        ...
        pausa_larga()
        print(Fore.RED + "Carmilla: Lo lamento...")
        pausa_larga()
